            ...
            return (
              <TouchableOpacity
                ...
                style={[
                  ...
                  isToday && !isSelected && S.dayChipToday,
                ]}
                onPress={() => setSelected(idx)}
              >
                <Text style={[S.dayShort, isSelected && S.dayShortActive]}>
                  {DAY_SHORT[idx]}
                </Text>
                {count > 0 && (
            ...
            {[1, 2, 3].map((k) => (
              <View key={k} style={S.skeleton}>
                ...
                <View style={S.skeletonRight}>
                  ...
                  <View
                    style={[S.skeletonLine, { width: "60%", marginTop: 8 }]}
                  />
                  <View
                    style={[S.skeletonLine, { width: "40%", marginTop: 8 }]}
                  />
                </View>
              </View>
            ))}
            ...
            return (
              <View key={idx} style={[S.card, { borderLeftColor: col.border }]}>
                ...
                <View style={[S.timeCol, { backgroundColor: col.bg }]}>
                  ...
                  />
                  <Text style={[S.timeText, { color: col.text }]}>
                    {item.time_start}
                  </Text>
                  ...
                  <View style={S.metaRow}>
                    ...
                    <View
                      style={[
                        ...
                        {
                          backgroundColor:
                            item.status === "active" ? "#d1fae5" : "#f1f5f9",
                        },
                      ]}
                    >
                      <Text
                        style={[
                          ...
                          {
                            color:
                              item.status === "active" ? "#065f46" : "#64748b",
                          },
                        ]}
                      >
            ...
            <View style={S.weekGrid}>
              {DAYS.map((day, idx) => {
                ...
                return (
                  ...
                  >
                    <Text
                      style={[S.weekCellDay, isToday && S.weekCellDayToday]}
                    >
                      {DAY_SHORT[idx]}
                    </Text>
                    <Text
                      style={[S.weekCellCount, isToday && S.weekCellCountToday]}
                    >
                      {cnt > 0 ? `${cnt}` : "—"}
                    </Text>
                  </TouchableOpacity>
